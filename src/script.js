...
function addCurso2(){
    ...
    //html del elemento creado
    art.innerHTML='<div class="col-3"><img class="logo logoCurso2"></div><div class="col info"><div class="edit"><p class="title nombreCurso2"></p><div class="buttons"><button class="btn-edit" style="display:block" onclick="deletes(this)"><img src="https://i.ibb.co/d07JS50/del.png" alt="edit" class="icon-edit"></button></div></div><p class="fechaCurso2"></p><p class="tituloCurso2"></p></div>';
...
function addProyect2(){
    ...
    //html del elemento creado
    art.innerHTML='<iframe class="col-5 imgProyect2" src="" width="444" height="250" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe><div class="col desc"><div class="edit"><p class="title nombreProyect2"></p><div class="buttons"><button class="btn-edit" style="display:block" onclick="deletes(this)"><img src="https://i.ibb.co/d07JS50/del.png" alt="edit" class="icon-edit"></button></div></div><p class="descProyect2"></p><p>Puede verse el código <a class="linkProyect2" href="" >aquí</a></p></div>';
